import { Injectable, CanActivate, ExecutionContext, Inject, HttpStatus, UnauthorizedException, Logger } from '@nestjs/common';
...
export class AuthGuard implements CanActivate {
  ...
  async validateRequest(request): Promise<boolean> {
    ...
    try {
      ...
      const response: UserTokenDto = await this.userServiceClient.send(pattern, {
